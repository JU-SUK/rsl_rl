...
import rsl_rl
from rsl_rl.algorithms import DistillationLegacy as Distillation
from rsl_rl.env import VecEnv
from rsl_rl.modules import StudentTeacher
from rsl_rl.runners._on_policy_runner_legacy import OnPolicyRunnerLegacy
from rsl_rl.utils import resolve_obs_groups, store_code_state


class DistillationRunnerLegacy(OnPolicyRunnerLegacy):
    ...
    def _construct_algorithm(self, obs: TensorDict) -> Distillation:
        ...
        student_teacher: StudentTeacher = student_teacher_class(
